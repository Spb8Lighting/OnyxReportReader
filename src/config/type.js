module.exports = {
  PatchXML: {
    ...
    FileExt: '.onyxpatch.xml,.Fixture.Onyx.xml',
    Regex: /\.(onyxpatch|fixture\.onyx)\.xml$/i
  },
  FixtureGroupXML: {
    Name: 'Groups',
    ...
    FileExt: '.OnyxFixtureGroup.xml,.FixtureGroup.Onyx.xml',
    Regex: /\.(onyxfixturegroup|fixtureGroup\.onyx)\.xml$/i
  },
  PresetXML: {
    Name: 'Presets',
    ...
    FileExt: '.OnyxPresetsUsageReport.xml,.Preset.Onyx.xml',
    Regex: /\.(onyxpresetsusagereport|preset\.onyx)\.xml$/i
  },
  CuelistXML: {
    Name: 'Cuelists',
    ...
    FileExt: '.OnyxCuelistReport.xml,.Cuelist.Onyx.xml',
    Regex: /\.(onyxcuelistreport|cuelist\.onyx)\.xml$/i
  }
}
