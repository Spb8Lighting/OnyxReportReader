module.exports = {
  PatchXML: {
    ...
    FileExt: '.Fixture.Onyx.xml',
    Regex: /\.fixture\.onyx\.xml$/i
  },
  FixtureGroupXML: {
    Name: 'Groups',
    ...
    FileExt: '.FixtureGroup.Onyx.xml',
    Regex: /\.fixtureGroup\.onyx\.xml$/i
  },
  PresetXML: {
    Name: 'Presets',
    ...
    FileExt: '.Preset.Onyx.xml',
    Regex: /\.preset\.onyx\.xml$/i
  },
  CuelistXML: {
    Name: 'Cuelists',
    ...
    FileExt: '.Cuelist.Onyx.xml',
    Regex: /\.cuelist\.onyx\.xml$/i
  }
}
